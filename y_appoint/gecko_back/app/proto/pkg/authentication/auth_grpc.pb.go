...
func (c *authenticationClient) Register(ctx context.Context, in *RegisterRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
...
func (c *authenticationClient) Logout(ctx context.Context, in *LoginRequest, opts ...grpc.CallOption) (*LoginResponse, error) {
	out := new(LoginResponse)
...
func (UnimplementedAuthenticationServer) Register(context.Context, *RegisterRequest) (*LoginResponse, error) {
...
func (UnimplementedAuthenticationServer) Logout(context.Context, *LoginRequest) (*LoginResponse, error) {
...
func _Authentication_Logout_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthenticationServer).Logout(ctx, req.(*LoginRequest))
	}
	return interceptor(ctx, in, info, handler)
}
